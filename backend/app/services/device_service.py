...
from app.services.ota_service import check_update_available
...
def process_heartbeat(
    ...
    ota_firmware = check_update_available(
        db=db,
        device=device,
    )
    ...
    if ota_firmware:
        response_ota = {
            "available": True,
            "firmware_id": ota_firmware.id,
            "version": ota_firmware.version,
            "download_url": ota_firmware.download_url,
            "sha256": ota_firmware.sha256,
            "file_size": ota_firmware.file_size,
        }
